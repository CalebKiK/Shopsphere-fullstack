...
with app.app_context():
    ...
    items = [
        Item(item_name= "Casual T-Shirt", description= "A comfortable and casual t-shirt for everyday wear.", price= 1999, category= "Clothes", items_available= 50, image_url= "/static/Assets/clothes/black tshirt.jpeg"),
        Item(item_name= "Classic Blue T-Shirt", description= "Stylish denim jacket with a classic fit.", price= 4999, category= "Clothes", items_available= 30, image_url= "/static/Assets/clothes/blue tshirt.jpeg"),
        Item(item_name= "Classic Red T-Shirt", description= "Stylish denim jacket with a classic fit.", price= 3999, image_url= "/static/Assets/clothes/red tshirt.jpeg", category= "Clothes", items_available= 35),
        ...
        Item(item_name= "Running Shoes", price= 2000, category= "Shoes", items_available= 22, image_url= "/static/images/RS.jpeg"),
        Item(item_name= "Casual Shoes", price= 9500, category= "Shoes", items_available= 30, image_url= "/static/images/CS.webp"),
        Item(item_name= "Formal Shoes", price= 6000, category= "Shoes", items_available= 22, image_url= "/static/images/FS.jpg"),
        Item(item_name= "Sneakers", price= 5500, category= "Shoes", items_available= 26, image_url= "/static/images/Sneakers.jpg"),
        Item(item_name= "Boots", price= 5000, category= "Shoes", items_available= 17, image_url= "/static/images/Boots.jpg"),
        Item(item_name= "OnePlus Vortex 9 Smartphone", price= 35000, category= "Electronics", items_available= 12, image_url= "/static/images/SP.webp"),
        Item(item_name= "ZenBook Pro 14 Laptop", price= 60000, category= "Electronics", items_available= 19, image_url= "/static/images/LP.webp"),
        Item(item_name= "BassBoost Wireless 4 Headphones", price= 5000, category= "Electronics", items_available= 10, image_url= "/static/images/HP.jpg"),
        Item(item_name= "FitTrack Pro 3 Smartwatch", price= 12000, category= "Electronics", items_available= 15, image_url= "/static/images/SW.webp"),
        Item(item_name= "TabMaster X10 Tablet", price= 22000, category= "Electronics", items_available= 14, image_url= "/static/images/Tablet.jpg"),
        Item(item_name= "Levi's 501 Original Blue Jeans", description= "Classic blue jeans with a modern fit.", price= 3999, category= "Clothes", items_available= 17, image_url= "/static/Assets/whatsnew/Blue jeans.jpeg"),
        Item(item_name= "White Sneakers", description= "Comfortable and stylish sneakers.", price= 5999, category= "Shoes", items_available= 18, image_url= "/static/Assets/whatsnew/Fashion men sneakers.jpeg"),
        Item(item_name= "Champion Reverse Weave Hoodie", description= "Soft and warm Hoodie.", price= 4500, category= "Clothes", items_available= 31, image_url= "/static/Assets/whatsnew/Grey hoodie.jpeg"),
        Item(item_name= "Classic Fit Polo Shirt", price= 3999, category= "Clothes", items_available= 21, offer_price= 2599, image_url= "/static/images/Classic Fit Polo Shirt.jpg"),
        Item(item_name= "Women's Ankle Boots", price= 6999, category= "Shoes", items_available= 22, offer_price= 3999, image_url= "/static/images/Women's Ankle Boots.jpg"),
        Item(item_name= "Atomic Habits by James Clear", price= 1899, category= "Books", items_available= 30, offer_price= 1199, image_url= "/static/images/'Atomic Habits' by James Clear.jpg"),
        Item(item_name= "Abstract Canvas Painting", price= 9999, category= "Artwork", items_available= 11, offer_price= 6399, image_url= "/static/images/Abstract Canvas Painting.jpg"),
        Item(item_name= "Wireless Bluetooth Earbuds", price= 5699, category= "Electronics", items_available= 18, offer_price= 2999, image_url= "/static/images/Wireless Bluetooth Earbuds.jpg"),
        Item(item_name= "Maxi Dress with Floral Print", price= 5999, category= "Clothes", items_available= 7, offer_price= 3499, image_url= "/static/images/Maxi Dress with Floral Print.jpg"),
        Item(item_name= "Becoming by Michelle Obama", price= 2499, category= "Books", items_available= 10, offer_price= 1599, image_url= "/static/images/'Becoming' by Michelle Obama.jpg"),
        Item(item_name= "Smartwatch with Fitness Tracker", price= 12999, category= "Electronics", items_available= 12, offer_price= 6999, image_url= "/static/images/Smartwatch with Fitness Tracker.jpg"),
        Item(item_name= "Handcrafted Ceramic Sculpture", price= 4499, category= "Artwork", items_available= 5, offer_price= 7999, image_url= "/static/images/Handcrafted Ceramic Sculpture.jpg"),
        Item(item_name= "Leather Oxford Shoes", price= 5499, category= "Shoes", items_available= 11, image_url= "/static/images/Leather Oxford Shoes.jpg"),
        Item(item_name= "Psychology of Money by Morgan Housel", price= 1999, category= "Books", items_available= 20, image_url= "/static/images/The Psychology of Money by Morgan Housel.jpg"),
        Item(item_name= "Men's Slim Fit Chinos", price= 6799, category= "Clothes", items_available= 23, image_url= "/static/images/Men's Slim Fit Chinos.jpg"),
        Item(item_name= "Canon EOS R5 Digital Camera", price= 49999, category= "Electronics", items_available= 8, image_url= "/static/images/Digital Camera.jpg"),
        Item(item_name= "Laptop Backpack", price= 5899, category= "Electronics", items_available= 11, image_url= "/static/images/Laptop Backpack.jpg"),
        Item(item_name= "Women's Espadrille Wedges", price= 4899, category= "Shoes", items_available= 15, image_url= "/static/images/Women's Espadrille Wedges.jpg"),
        Item(item_name= "The Alchemist by Paulo Coelho", price= 1499, category= "Books", items_available= 29, image_url= "/static/images/The Alchemist by Paulo Coelho.jpg"),
        Item(item_name= "Modern Geometric Wall Art", price= 8199, category= "Artwork", items_available= 30, image_url= "/static/images/Modern Geometric Wall Art.jpg"),
        Item(item_name= "White Leather Sneakers", price= 7599, category= "Shoes", items_available= 5, image_url= "/static/images/White Leather Sneakers.jpg"),
        Item(item_name= "Subtle Art of Not Giving a F*ck by Mark Manson", price= 1799, category= "Books", items_available= 9, image_url= "/static/images/Subtle Art of Not giving a F.jpg"),
        Item(item_name= "Men's Running Sneakers", price= 8999, category= "Shoes", items_available= 31, offer_price= 4999, image_url= "/static/images/Men's Running Sneakers.jpg")
    ]
